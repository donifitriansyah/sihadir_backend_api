...
class JadwalController extends Controller
{
    ...
    public function jadwalMahasiswa(Request $request)
    {
        ...
        $jadwalHariIni = DB::table('jadwals')
            ...
            ->select('jadwals.id_jdwl', 'matkuls.nama as Mata Kuliah', DB::raw('CONCAT(TIM  E_FORMAT(jadwals.start, "%H.%i"), " - ",TIME_FORMAT(jadwals.finish , "%H.%i")) AS Waktu'), 'kelas.smt', 'kelas.abjad_kls', 'jadwals.ruang', 'jadwals.jumlah_jam')
            ->get();
    }
